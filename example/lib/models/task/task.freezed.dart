...
mixin _$Task {
  ...
  User get ownerBy => throw _privateConstructorUsedError;
...
class _$TaskCopyWithImpl<$Res> implements $TaskCopyWith<$Res> {
  ...
  @override
  $UserCopyWith<$Res> get ownerBy {
    return $UserCopyWith<$Res>(_value.ownerBy, (value) {
      return _then(_value.copyWith(ownerBy: value));
    });
  }
}
...
class _$_Task implements _Task {
  const _$_Task(
      ...
      required final List<User> owners,
  ...
  @override
  String toString() {
    return 'Task(id: $id, owner: $owner, ownerBy: $ownerBy, owners: $owners, checks: $checks)';
  }
...
abstract class _Task implements Task {
  const factory _Task(
      ...
      required final User ownerBy,
      required final List<User> owners,
      required final List<Check> checks}) = _$_Task;
